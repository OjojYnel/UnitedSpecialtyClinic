        ...
        <div class="panel panel-primary">
          ...
          <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group">
              ...
              <div class="">
                {!! Form::text('service_name','',['class' => 'form-control','placeholder'=>'Enter Service']) !!}
              </div>
            </div>
          </div>
          ...
          <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group">
              ...
              <div class="">
                {!! Form::date('appointment_date','',['class' => 'form-control']) !!}
              </div>
            </div>
          </div>
          ...
          <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group">
              ...
              <div class="">
                {!! Form::time('from','',['class' => 'form-control']) !!}
              </div>
            </div>
          </div>
          ...
          <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group">
              ...
              <div class="">
                {!! Form::time('to','',['class' => 'form-control']) !!}
              </div>
            </div>
          </div>

          <div class="col-xs-1 col-sm-1 col-md-1 text-center">&nbsp;<br/>
            {!! Form::submit('Add Appointment',['class' => 'btn btn primary']) !!}
          </div> 
        </div>
        {!! Form::close() !!}
      </div>
